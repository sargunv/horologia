...
func (s *TaskEffortLevel) GetIcon() NilString {
	return s.Icon
}
...
func (s *TaskEffortLevel) SetIcon(val NilString) {
	s.Icon = val
}
...
// GetIcon returns the value of Icon.
func (s *TaskEffortLevelInput) GetIcon() OptNilString {
	return s.Icon
}
...
// SetIcon sets the value of Icon.
func (s *TaskEffortLevelInput) SetIcon(val OptNilString) {
	s.Icon = val
}
...
type TaskPriorityLevel struct {
	Name     string `json:"name"`
	Position int64  `json:"position"`
	// Lucide icon name in kebab-case (e.g. "signal-high", "flag"). Null if no icon is set.
	Icon NilString `json:"icon"`
}
...
// GetIcon returns the value of Icon.
func (s *TaskPriorityLevel) GetIcon() NilString {
	return s.Icon
}
...
// SetIcon sets the value of Icon.
func (s *TaskPriorityLevel) SetIcon(val NilString) {
	s.Icon = val
}
...
type TaskPriorityLevelInput struct {
	Name string `json:"name"`
	// Lucide icon name in kebab-case (e.g. "signal-high", "flag"). Omit or set to null to clear.
	Icon OptNilString `json:"icon"`
}
...
// GetIcon returns the value of Icon.
func (s *TaskPriorityLevelInput) GetIcon() OptNilString {
	return s.Icon
}
...
// SetIcon sets the value of Icon.
func (s *TaskPriorityLevelInput) SetIcon(val OptNilString) {
	s.Icon = val
}
