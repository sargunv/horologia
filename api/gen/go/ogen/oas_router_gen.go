		...
		case '/': // Prefix: "/"
			...
			case 'r': // Prefix: "recipes"
				...
				if len(elem) == 0 {
					switch r.Method {
					case "GET":
						s.handleRecipesListRequest([0]string{}, elemIsEscaped, w, r)
					default:
						s.notAllowed(w, r, notAllowedParams{
							allowedMethods: "GET",
				...
				case '/': // Prefix: "/search"
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "GET":
							s.handleRecipesSearchRequest([0]string{}, elemIsEscaped, w, r)
						default:
							s.notAllowed(w, r, notAllowedParams{
								allowedMethods: "GET",
			...
			case 's': // Prefix: "s"
				...
				switch elem[0] {
				case 'e': // Prefix: "erver-info"

					if l := len("erver-info"); len(elem) >= l && elem[0:l] == "erver-info" {
						elem = elem[l:]
					} else {
						break
					}
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "GET":
							s.handleServerInfoGetRequest([0]string{}, elemIsEscaped, w, r)
						default:
							s.notAllowed(w, r, notAllowedParams{
								allowedMethods: "GET",
								allowedHeaders: nil,
				...
				case 'p': // Prefix: "paces"
					...
					if l := len("paces"); len(elem) >= l && elem[0:l] == "paces" {
						elem = elem[l:]
					} else {
						break
					}
						...
						case '/': // Prefix: "/"
							...
							case 'r': // Prefix: "recipes"
								...
								if len(elem) == 0 {
									switch r.Method {
									case "GET":
										s.handleSpaceRecipesListRequest([1]string{
											args[0],
										}, elemIsEscaped, w, r)
									case "POST":
										s.handleSpaceRecipesCreateRequest([1]string{
											args[0],
										}, elemIsEscaped, w, r)
									default:
										s.notAllowed(w, r, notAllowedParams{
								...
								case '/': // Prefix: "/"
									...
									if len(elem) == 0 {
										switch r.Method {
										case "DELETE":
											s.handleSpaceRecipesDeleteRequest([2]string{
												args[0],
												args[1],
											}, elemIsEscaped, w, r)
										case "GET":
											s.handleSpaceRecipesReadRequest([2]string{
												args[0],
												args[1],
											}, elemIsEscaped, w, r)
										case "PATCH":
											s.handleSpaceRecipesUpdateRequest([2]string{
												args[0],
												args[1],
											}, elemIsEscaped, w, r)
										default:
									...
									case '/': // Prefix: "/activity"
										...
										if len(elem) == 0 {
											...
											switch r.Method {
											case "GET":
												s.handleSpaceRecipeActivityListRequest([2]string{
													args[0],
													args[1],
												}, elemIsEscaped, w, r)
											default:
			...
			case 't': // Prefix: "tasks/search"

				if l := len("tasks/search"); len(elem) >= l && elem[0:l] == "tasks/search" {
					elem = elem[l:]
				} else {
					break
				}
				...
				if len(elem) == 0 {
					...
					switch r.Method {
					case "GET":
						s.handleTasksSearchRequest([0]string{}, elemIsEscaped, w, r)
					default:
						s.notAllowed(w, r, notAllowedParams{
							allowedMethods: "GET",
					...
					case '/': // Prefix: "/"
						...
						case 't': // Prefix: "tasks"
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "GET":
									s.handleUserTasksListRequest([1]string{
										args[0],
									}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, notAllowedParams{
		...
		case '/': // Prefix: "/"
			...
			case 'r': // Prefix: "recipes"
				...
				if len(elem) == 0 {
					switch method {
					case "GET":
						r.name = RecipesListOperation
						r.summary = ""
						r.operationID = "Recipes_list"
						r.operationGroup = ""
				...
				case '/': // Prefix: "/search"
					...
					if len(elem) == 0 {
						...
						switch method {
						case "GET":
							r.name = RecipesSearchOperation
							r.summary = ""
							r.operationID = "Recipes_search"
							r.operationGroup = ""
							r.pathPattern = "/recipes/search"
							r.args = args
							r.count = 0
							return r, true
						default:
			...
			case 's': // Prefix: "s"
				...
				case 'e': // Prefix: "erver-info"
					...
					if len(elem) == 0 {
						...
						switch method {
						case "GET":
							r.name = ServerInfoGetOperation
							r.summary = ""
							r.operationID = "ServerInfo_get"
							r.operationGroup = ""
						...
						case '/': // Prefix: "/"
							...
							case 'r': // Prefix: "recipes"
								...
								if len(elem) == 0 {
									switch method {
									case "GET":
										r.name = SpaceRecipesListOperation
										r.summary = ""
										r.operationID = "SpaceRecipes_list"
										r.operationGroup = ""
										r.pathPattern = "/spaces/{spaceSlug}/recipes"
										r.args = args
										r.count = 1
										return r, true
									case "POST":
										r.name = SpaceRecipesCreateOperation
										r.summary = ""
										r.operationID = "SpaceRecipes_create"
										r.operationGroup = ""
										r.pathPattern = "/spaces/{spaceSlug}/recipes"
										r.args = args
										r.count = 1
								...
								case '/': // Prefix: "/"
									...
									if len(elem) == 0 {
										switch method {
										case "DELETE":
											r.name = SpaceRecipesDeleteOperation
											r.summary = ""
											r.operationID = "SpaceRecipes_delete"
											r.operationGroup = ""
											r.pathPattern = "/spaces/{spaceSlug}/recipes/{recipeId}"
											r.args = args
											r.count = 2
											return r, true
										case "GET":
											r.name = SpaceRecipesReadOperation
											r.summary = ""
											r.operationID = "SpaceRecipes_read"
											r.operationGroup = ""
											r.pathPattern = "/spaces/{spaceSlug}/recipes/{recipeId}"
											r.args = args
											r.count = 2
											return r, true
										case "PATCH":
											r.name = SpaceRecipesUpdateOperation
											r.summary = ""
											r.operationID = "SpaceRecipes_update"
											r.operationGroup = ""
											r.pathPattern = "/spaces/{spaceSlug}/recipes/{recipeId}"
											r.args = args
											r.count = 2
									...
									case '/': // Prefix: "/activity"
										...
										if len(elem) == 0 {
											...
											switch method {
											case "GET":
												r.name = SpaceRecipeActivityListOperation
												r.summary = ""
												r.operationID = "SpaceRecipeActivity_list"
												r.operationGroup = ""
												r.pathPattern = "/spaces/{spaceSlug}/recipes/{recipeId}/activity"
												r.args = args
												r.count = 2
												return r, true
											default:
			...
			case 't': // Prefix: "tasks/search"
				...
				if len(elem) == 0 {
					...
					switch method {
					case "GET":
						r.name = TasksSearchOperation
						r.summary = ""
						r.operationID = "Tasks_search"
						r.operationGroup = ""
						r.pathPattern = "/tasks/search"
						r.args = args
						r.count = 0
						return r, true
					default:
					...
					case '/': // Prefix: "/"
						...
						case 't': // Prefix: "tasks"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "GET":
									r.name = UserTasksListOperation
									r.summary = ""
									r.operationID = "UserTasks_list"
									r.operationGroup = ""
