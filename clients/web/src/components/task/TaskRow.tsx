...
export function TaskRow({
  ...
  return (
    <Link
      ...
      className="group relative flex items-center gap-2 border-b border-base-300 px-3 py-2 transition-colors last:border-b-0 hover:bg-base-200 data-[status=active]:bg-base-200"
    >
      {staleness != null && (
        <div
